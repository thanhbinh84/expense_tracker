...
final mockTrx2 =
    Trx(amount: 2, desc: 'desc2', dateTime: DateTime(2025, 1, 10), category: Category.shopping);
final mockTrx3 =
    Trx(amount: 3, desc: 'desc3', dateTime: DateTime(2024, 11, 20), category: Category.travel);
